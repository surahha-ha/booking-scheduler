...
// 서비스 항목 선택 규칙
// ----------------------------------------------------------------------------
// 방문내용 선택기(TreatmentContentSelector)와 예약 팝업(ReservationPopup)이 함께 쓴다.
// 두 곳이 같은 판정을 각자 들고 있으면 버튼 색과 저장 게이트가 갈린다(실제로 갈렸다).
//
// 서비스 항목은 선택값이다(PRD FR-8.2). 다만 선택 가능한 항목이 있는 그룹을 골랐다면
